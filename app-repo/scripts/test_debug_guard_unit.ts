...
// Mock ModeGate
const originalDebugEnabled = ModeGate.debugEndpointsEnabled;
...
function runTests() {
  ...
  // Cleanup
  ModeGate.debugEndpointsEnabled = originalDebugEnabled;
